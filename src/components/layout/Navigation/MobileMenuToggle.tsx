...
const MobileMenuToggle = () => {
  ...
  return (
    <>
      ...
      <button
        className="md:hidden flex flex-col justify-center items-center w-8 h-8 p-1 rounded-md hover:bg-accent/10 transition-colors"
      ...
      {isMobileMenuOpen && (
        <>
          ...
          <div className={cn(
            "fixed right-0 bg-base shadow-2xl z-50 md:hidden",
            "w-80 max-w-[85vw]",
            "transform transition-transform duration-300 ease-in-out",
            isMobileMenuOpen ? "translate-x-0" : "translate-x-full"
          )}
          style={{ 
            top: '60px', // Justo debajo del navbar (altura aproximada)
