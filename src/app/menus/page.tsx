...
export const metadata: Metadata = {
  ...
  description:
    "Menús diarios y especiales para grupos en Eimar Paiporta. Primeros, segundos, postres y bebida incluida.",
  keywords:
    "menú diario Paiporta, menú grupos Paiporta, menú especial, restaurante Paiporta",
};
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-16">
          ...
          <section>
            <div className="max-w-4xl mx-auto">
              <h2 className="ds-section-title text-center mb-4">Menú Diario</h2>
              <p
                className="ds-body-xl text-center mb-12"
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div>
                    <h3
                      className="ds-h3 text-center mb-6"
                ...
                <div className="bg-bg-accent/20 rounded-xl p-8 text-center mb-6">
                  ...
                  <p
                    className="ds-body-xl"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    El precio del menú incluye primer plato, segundo plato,
                    postre, pan, una bebida y café o infusión.
                  </p>
                </div>
                ...
                <div className="bg-bg-muted border-2 border-gray-300 rounded-lg p-6">
                  <p
                    className="ds-body-base text-center"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    ⚠️ <strong>Aviso:</strong> Ejemplo de menú, varía
                    diariamente.
                  </p>
                  <p
                    className="ds-body-sm text-center mt-2"
          ...
          <section>
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-8">
                <h3
                  className="ds-h3 text-center mb-2"
                  style={{ color: "var(--color-text-accent)" }}
                >
                  MENÚ DE GRUPOS
                </h3>
                <p
                  className="ds-body-base text-center mb-8"
                  style={{ color: "var(--color-text-secondary)" }}
                >
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <span className="ds-badge bg-bg-accent text-white px-3 py-1 rounded-full text-sm font-medium">
                        4
                      </span>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="ds-body-base">
                        Ensalada de Burrata, cogollos la brasa y vinagreta de
                        frutos rojos
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span className="ds-body-base">
                        Entraña a la brasa con patatas fritas y chimichurri
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <div
                    className="ds-list-bulleted space-y-2 ds-body-base"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                  ...
                  <p
                    className="mt-4 ds-body-base"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    Pan con tomate y alioli, bebida.
                  </p>
                  <p
                    className="ds-body-base font-semibold"
                    style={{ color: "var(--color-text-accent)" }}
                  >
                    CAFÉ INCLUIDO.
                  </p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-bg-accent/10 rounded-lg p-6 text-center">
                    <h5
                      className="ds-h4 mb-2"
                      style={{ color: "var(--color-text-accent)" }}
                    >
                      Opción Estándar
                    </h5>
                    <p
                      className="ds-menu-price text-3xl font-bold mb-2"
                      style={{ color: "var(--color-text-accent)" }}
                    >
                      25,00€
                    </p>
                    ...
                    <p
                      className="ds-body-xs mt-1"
                      style={{ color: "var(--color-text-muted)" }}
                    >
                      (1 bebida cada 4 personas)
                    </p>
                  </div>
                  <div className="bg-bg-accent/20 rounded-lg p-6 text-center">
                    ...
                    <p
                      ...
                      style={{ color: "var(--color-text-muted)" }}
                    >
                      (barra libre durante la comida, hasta sacar el plato de
                      entraña)
                    </p>
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-bg-accent/80 rounded-2xl p-8 text-center text-text-inverse">
              <h3 className="ds-h3 mb-4">¿Organizas un evento?</h3>
              <p className="ds-body-xl text-text-primary! opacity-90 mb-6">
                Contacta con nosotros para reservar tu menú de grupo
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/reservas-y-pedidos">
                  <Button variant="primary">Reservar Grupo</Button>
                </Link>
                <Link href="#contacto">
