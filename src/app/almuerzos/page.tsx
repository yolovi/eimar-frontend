...
export const metadata: Metadata = {
  ...
  description:
    "Deliciosos desayunos y almuerzos en Paiporta. Tostas artesanales, bocadillos y menús de almuerzo con bebida incluida.",
  keywords:
    "desayunos Paiporta, almuerzos Paiporta, tostas, bocadillos, menú almuerzo",
};
    ...
    >
      ...
      <section className="py-6">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <Link href="/menu">
            <Button variant="secondary">← Volver a la Carta</Button>
          </Link>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-16">
          ...
          <section>
            <div className="max-w-4xl mx-auto">
              <h2 className="ds-section-title text-center mb-12">Desayunos</h2>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                <div className="space-y-6">
                  ...
                  <div className="flex justify-between items-center border-b border-gray-100 pb-4">
                    <div>
                      <h3 className="ds-menu-title">Tosta de aceite y sal</h3>
                    </div>
                    <span
                      className="ds-menu-price"
                  ...
                  <div className="bg-bg-accent/10 rounded-lg p-6 mt-6">
                    ...
                    >
                      <strong>+ 1,75€</strong> zumo de naranja / agua / refresco
                      / doble de cerveza / café
                      <span className="ds-body-sm block mt-1">
                        (cremaet +1€)
                      </span>
                    </p>
                  </div>
                ...
                {/* Imagen de desayuno */}
                <figure className="bg-bg-muted rounded-xl p-6 text-center">
                  <Image
                    src="/images/menu/desayuno.jpg"
                    alt="Deliciosas tostas artesanales para desayuno en Eimar"
                    width={600}
                    height={400}
                    className="mx-auto rounded-lg"
                  />
                  <figcaption
                    className="ds-body-sm mt-4"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    Nuestras tostas artesanales - Desayunos en Eimar Paiporta
                  </figcaption>
                </figure>
              </div>
            </div>
          ...
          <section>
            <div className="max-w-4xl mx-auto">
              <h2 className="ds-section-title text-center mb-12">Almuerzos</h2>

              <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                {/* Horarios */}
                <div className="bg-bg-accent/10 rounded-lg p-6 mb-8">
                  <h3
                    className="ds-h4 mb-3"
                    style={{ color: "var(--color-text-accent)" }}
                  >
                    Horarios de Almuerzo
                  </h3>
                  <div
                    className="space-y-1 ds-body-base"
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    <p>
                      <strong>Lunes a Jueves:</strong> De 9:30h a 12:00h
                    </p>
                    <p>
                      <strong>Viernes, Sábado, Domingo y festivos:</strong> De
                      9:30h a 11:30h
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-bg-muted rounded-lg p-6 mb-8">
                  ...
                  >
                    <p className="mb-2">
                      <strong>Bebida:</strong> Refresco 350cl / Agua 0.5cl /
                      Doble de barril / Vino de la casa / Vino-gaseosa / Tinto
                      de verano
                    </p>
                    <p className="mb-2">
                      <strong>Acompañamientos:</strong> Aceitunas variadas /
                      Encurtidos / Cacaos fritos
                    </p>
                    <p>
                      <strong>Café incluido</strong>{" "}
                      <span className="ds-body-sm">(*cremaet +1€)</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-bg-accent/10 rounded-lg p-6 text-center">
                    ...
                    <p
                      className="ds-menu-price text-3xl font-bold"
                      style={{ color: "var(--color-text-accent)" }}
                    >
                      7,25€
                    </p>
                ...
                <div className="text-center mb-8">
                  <Link href="/menu#menu-bocadillos">
                ...
                <figure className="bg-bg-muted rounded-xl p-6 text-center">
                  <Image
                    src="/images/menu/almuerzo.jpg"
                    alt="Bocadillo completo con bebida y café - Almuerzo en Eimar"
                    width={600}
                    height={400}
                    className="mx-auto rounded-lg"
                  />
                  <figcaption
                    ...
                    style={{ color: "var(--color-text-secondary)" }}
                  >
                    Almuerzo completo con bebida y café incluidos - Eimar
                    Paiporta
                  </figcaption>
                </figure>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-bg-accent/80 rounded-2xl p-8 text-center text-text-inverse">
              <h3 className="ds-h3 mb-4">¿Listo para disfrutar?</h3>
              <p className="ds-body-xl opacity-90 mb-6">
                Ven a Eimar y disfruta de nuestros desayunos y almuerzos en
                Paiporta
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/reservas-y-pedidos">
                  <Button variant="secondary">Hacer Reserva</Button>
                </Link>
                <Link href="#contacto">
